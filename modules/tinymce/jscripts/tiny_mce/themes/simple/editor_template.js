...
var TinyMCE_SimpleTheme = {
	...
	_buttonMap : 'bold,bullist,cleanup,italic,numlist,redo,strikethrough,underline,undo,advlink,unlink',
	...
	getEditorTemplate : function() {
		...
		html += tinyMCE.getButtonHTML('advlink', 'lang_link_desc', '{$themeurl}/images/link.gif', 'advlink');
